...
export function ApplicationMenuBar({ room, mode, personPanelVisible, wallMode, floorplanStyle, displayUnits, onOpenRoom, onOpenCatalogue, onTogglePersonPanel, onWallModeChange, onFloorplanStyleChange, onExportFloorplan, onOpenSettings, toolbars, toolbarVisibility, onToggleToolbar, onShowAllToolbars, onHideAllToolbars }: ApplicationMenuBarProps) {
