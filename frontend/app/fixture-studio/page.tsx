...
function Studio() {
  ...
  return <div style={{position:"fixed",inset:0,background:"#eef0ed"}}>
    <StableCanvas shadows orthographic dpr={2} gl={{antialias:true,preserveDrawingBuffer:true}} camera={{position:[extent*(cabinet ? 1.1 : 1.6),extent*(bath ? 1.65 : cabinet ? .9 : 1.5),extent*2.4],zoom:440/extent,near:.001,far:100}} onCreated={({camera}) => camera.lookAt(0,height*.47,0)}>
